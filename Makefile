...
PROGNAME = CS2110JaeMinBaek

# The object files you want to compile into your program
# This should be a space (SPACE!) separated list of .o files
OFILES = main.o myLib.o text.o font.o gtLogo3.o bullDog5.o bullDog10.o bullDog15.o bullDog20.o bullDog30.o background.o gtWin.o deadBee.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h text.h gtLogo3.h bullDog5.h bullDog10.h bullDog15.h bullDog20.h bullDog30.h background.h gtWin.h deadBee.h
